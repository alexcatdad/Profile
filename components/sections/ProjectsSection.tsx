      ...
      <div className="grid gap-4 md:grid-cols-2">
        {projects.map((project, index) => (
          <article
            ...
            className="flex h-full flex-col rounded-3xl border border-white/10 bg-white/[0.03] p-5 text-sm text-zinc-200 shadow-apple"
          >
            {project.name && (
            ...
            {project.url && (
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 text-xs font-semibold text-emerald-300"
              >
                View project
